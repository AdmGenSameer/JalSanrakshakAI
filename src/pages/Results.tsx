                  ...
                  <Card className="glass-card border-0 shadow-water"><CardHeader><CardTitle className="flex items-center gap-2"><Droplets className="h-5 w-5 text-primary" />Aquifer Information</CardTitle></CardHeader><CardContent>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="space-y-4">
                        ...
                        <div><h4 className="font-semibold mb-2">Depth to Water</h4><p className="text-muted-foreground">{groundwaterQuery.data?.depth_to_water ? `${groundwaterQuery.data.depth_to_water} m` : assessment.water_depth ? `${assessment.water_depth} m` : '—'}</p></div>
                        <div><h4 className="font-semibold mb-2">Water Quality</h4><p className="text-muted-foreground">{groundwaterQuery.data?.water_quality || '—'}</p></div>
                      </div>
                      <div className="space-y-4">
